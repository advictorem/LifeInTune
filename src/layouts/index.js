...
import horizontalNoOrnament from '../assets/lifeintune-logo-horizontal-no-ornament.svg'
import horizontalWithOrnament from '../assets/life-in-tune-logo-horizontal-w-ornament.svg'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative">
            ...
            >
              <img 
                src={horizontalNoOrnament} 
                  alt="Horizontal Life in Tune logo" 
      ...
      <header className="fixed top-0 left-0 flex items-center w-full h-16 pr-5 bg-black xl:hidden">
        ...
        >
          <img 
            src={horizontalWithOrnament} 
            alt="Life in Tune Horizontal Logo with ornament"
            className="ease-out transition-slow"
